...
import com.epam.aidial.kubernetes.NoProgressApiCallback;
...
public class KubernetesService {
    ...
    private void initialize() {
        ServiceVersion version = ServiceVersion.parse(knativeServiceVersion);
    ...
    public Mono<Void> createJob(String namespace, V1Job job) {
    ...
    public Mono<String> createKnativeService(String namespace, V1Service service) {
        // Currently there is no asynchronous Watch api
    ...
    public Mono<Void> deleteKnativeService(String namespace, String name) {
        return Mono.create(sink -> {
            ServiceVersion version = ServiceVersion.parse(knativeServiceVersion);
    ...
    private record ServiceVersion(String group, String version) {
